...
plot.triangle(x=1, y=5, color=colors[7], angle=45, size=20)
plot.triangle(x=1, y=6, color=colors[8], angle=60, size=20)
plot.triangle(x=1, y=7, color=colors[9], angle=75, size=20)
plot.triangle(x=1, y=8, color=colors[10], angle=180, size=20)
mytext = Label(x=1, y=6, text='1844.22', x_offset = 6, y_offset=-7)
plot.add_layout(Arrow(end=VeeHead(line_color="firebrick", line_width=3),
